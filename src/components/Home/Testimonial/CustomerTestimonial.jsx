...
const CustomerTestimonial = () => {
  return (
    <div className="2xl:px-30 lg:px-5 px-4 mt-20 ">
      ...
      {/* testimonial */}
      <div className="flex 2xl:justify-between flex-col items-center lg:flex-row  gap-6 mt-10">
        {testimonials.map((testimonial) => (
          <div
            key={testimonial.id}
            className=" w-[411px] h-[369px]  bg-cover  bg-no-repeat p-6"
