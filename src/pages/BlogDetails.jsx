        ...
        <div className="flex gap-3">
          <div className="lg:w-3/4 w-full" >
            <div
              ...
              style={{
                background: `linear-gradient(0deg, rgba(0, 0, 0, 0.20) 0%, rgba(0, 0, 0, 0.20) 100%), url(${blog1}) lightgray 50% / cover no-repeat`,
              }}
            ></div>
            {/* date and ev */}
            ...
            <p className="w-full text-[#444] text-justify font-Poppins text-[16px] font-[400] leading-[35px] tracking-[0.48px]">
              Nisi quis eleifend quam adipiscing at vitae proin sagittis.
              Vulputate eu scel erisque felis imper diet. Vitae justo eget magna
              fermentum iaculis non diam phasellus. Et leo duis diam quam nulla.
              Diam donec adipi scing tristique risus nec feugiat consequat
              fermentum. Pellentesque habitant morbi tristique senectus et netus
              et malesuada. Imperdiet nulla malesuada pellentesque elit eget
              gravida cum sociis natoque. Tellus cras adipiscing enim eu turpis
              egestas pretium aenean. Sit amet nulla facilisi morbi. Nisl vel
              pretium lectus quam. Sed risus pretium quam vulputate dignissim
              suspendisse. Ultricies tristique nulla aliquet enim tortor nunc.
              Nulla posuere sollicitudin aliquam ultrices sagittis scelerisque
              purus.
            </p>
            <h2 className="text-[#000] text-[24px] font-[700] font-Playfair my-3">
              Hear what happy riders have to say about their Electric
              experience.
            </h2>
            <p className="text-[#444] text-justify font-Poppins text-[16px] font-[400] leading-[35px] tracking-[0.48px]">
              ...
              nulla vehicula felis, eu cursus sem tellus eget elit. Proin
              lacinia gravida elitThe point of using Lorem Ipsum is that it has
            ...
            <div className="flex flex-col gap-4 my-3">
              <div className="flex text-[#8CC63F] gap-4">
                ...
                <p className="text-[#101010] font-Poppins font-[500]">
                  Detachable battery, take home and charge in 3 hours heir
                  self-interest.
                </p>
              </div>
              ...
              <div className="flex text-[#8CC63F] gap-4">
                <Icon icon="lets-icons:check-fill" width="24" height="24" />
                <p className="text-[#101010] font-Poppins font-[500]">
                  Preparing for your success we provide truly Develop and
                  Propose.
                </p>
              </div>
            </div>
            ...
            <div className="mt-6 flex items-center justify-center w-full">
              <div className="flex gap-[55px] ">
                ...
                <div className="p-[10px] flex gap-[10px] items-center">
                  <div
                    className="bg-[#000] p-[2px] rounded-full hover:bg-[#00C853] tranistion-all ease-in duration-300 cursor-pointer"
                  ...
                  <p className="font-Poppins text-[16px] font-[500] text-[#000]">
                    Prev Post
                  </p>
                </div>
          ...
          <aside className="w-1/4 hidden lg:block">
            ...
            <div className="p-3 flex flex-col gap-2 w-full rounded-tr-[20px] rounded-bl-[20px] bg-[#F5F5F5] mt-3">
              <h2 className="text-[#000] font-Playfair text-[20px] font-[700] ">
                Recent Post
              </h2>
              {/* Post items */}
              <RecentPost />
            ...
            <div className="rounded-tr-[20px] rounded-bl-[20px] py-[27px] px-[13px] bg-[#F5F5F5] mt-3 ">
              <h2 className="font-Playfair text-[#000] text-[20px] font-[700] ">
                Tags
              </h2>
            ...
            {/* Support */}
            <div
              className="w-full aspect-8/9 rounded-tr-[20px] rounded-bl-[20px] mt-3 px-[30px] pt-[45px] pb-[64px]"
              style={{
            ...
            >
              <div className="flex flex-col gap-[18px] items-center justify-between h-full">
                <img src={careArtBoard} alt="" className="h-[74px] w-[78px]" />
                ...
                <div className="font-Poppins text-center font-[500] text-[#f5f5f5]">
                  <h2 className=" text-[18px] ">+977-9852367896</h2>
                  <p className="text-[16px]">Support@electric.com</p>
                </div>
                {/* contact */}
